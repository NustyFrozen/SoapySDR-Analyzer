...
namespace SoapySDR
{
    ...
    public:
         ...
         * \param args optional tuner arguments
         */
        virtual void setFrequency(const int direction, const size_t channel, const std::string& name,
                                  const double frequency, const Kwargs& args = Kwargs());
         ...
         */
        virtual std::vector<unsigned> readRegisters(const std::string& name, const unsigned addr,
         ...
         * \param value the setting value
         */
        virtual void writeSetting(const int direction, const size_t channel, const std::string& key,
...
template <typename Type>
void SoapySDR::Device::writeSetting(const int direction, const size_t channel, const std::string& key,
                                    const Type& value)
{
