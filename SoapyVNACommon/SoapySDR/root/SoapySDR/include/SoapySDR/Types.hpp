...
namespace SoapySDR
{
    namespace Detail
    {
        ...
        template <typename Type>
        typename std::enable_if<not std::is_same<Type, bool>::value and std::is_integral<Type>::value and std::is_signed
                                <Type>::value, Type>::type StringToSetting(const std::string& s)
        {
            return Type(std::stoll(s));
        }

        template <typename Type>
        typename std::enable_if<not std::is_same<Type, bool>::value and std::is_integral<Type>::value and
                                std::is_unsigned<Type>::value, Type>::type StringToSetting(const std::string& s)
        {
        ...
        template <typename Type>
        typename std::enable_if<std::is_same<typename std::decay<Type>::type, std::string>::value, Type>::type
        StringToSetting(const std::string& s)
        {
            return s;
        }
