...
namespace SoapyRL.UI
{
    internal class Theme
    {
        ...
        public static bool glowingInput(string label, ref string text, glowingInputConfigurator cfg, uint maxlength = 32)
        {
            ...
            bool valuechanged = ImGui.InputText(label, ref text, maxlength);
        ...
        public static bool glowingCombo(string label, ref int selectedIndx, string[] items, glowingInputConfigurator cfg, uint maxlength = 32)
        {
            label = "##" + label;
            object obj = cfg.borderColor;
            var borderColorActive = cfg.borderColorActive;
